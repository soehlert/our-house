...
from house.models import Device, Room
from house.forms import DeviceForm
...
def device_list(request):
    ...
    if search_query:
        ...
        return render(request, 'house/devices/list.html', {
            "object_list": devices,
            "search_mode": True,
        })
...
def device_detail(request, pk):
    ...
    return render(request, 'house/devices/detail.html', context)
...
def device_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if 'save_and_add_another' in request.POST:
                return redirect('house:device_create')
            else:
                return redirect('house:device_detail', pk=device.pk)
    else:
    ...
    return render(request, 'house/devices/form.html', {
        'form': form,
        'device': None
    })
...
def device_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('house:device_list')

    return render(request, 'house/devices/confirm_delete.html', {
        'device': device
    })
