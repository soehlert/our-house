...
from house.forms import PurchaseLocationForm
...
def purchase_location_list(request):
    ...
    return render(request, 'house/purchase_locations/list.html', {'object_list': locations})
...
def purchase_location_detail(request, pk):
    ...
    return render(request, 'house/purchase_locations/detail.html', {
        'location': location,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if 'save_and_add_another' in request.POST:
                return redirect('house:purchase_location_create')
            else:
                return redirect('house:purchase_location_detail', pk=purchase_location.pk)
    else:
        form = PurchaseLocationForm()

    return render(request, 'house/purchase_locations/form.html', {
        'form': form,
...
def purchase_location_delete(request, pk):
    ...
    return render(request, 'house/purchase_locations/confirm_delete.html', {'location': location})
