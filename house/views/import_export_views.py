...
def import_data(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'house/import_export.html')
    ...
    try:
        ...
        for circuit_data in json_data.get('circuits', []):
            try:
                ...
                if fields.get('diagrams'):
                    fields['diagrams'] = CircuitDiagram.objects.get(pk=fields['diagrams'])
            ...
            except (ElectricalPanel.DoesNotExist, CircuitDiagram.DoesNotExist):
                import_stats['skipped'] += 1
        ...
        for device_data in json_data.get('devices', []):
            try:
                ...
                # Handle attached_appliance foreign key
                appliance_pk = fields.get('attached_appliance')
                if appliance_pk is not None:
                    fields['attached_appliance'] = Appliance.objects.get(pk=appliance_pk)
            ...
            except (Room.DoesNotExist, Circuit.DoesNotExist, Appliance.DoesNotExist):
                import_stats['skipped'] += 1
