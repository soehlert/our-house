...
class Vehicle(models.Model):
    ...
    oil_capacity = models.CharField(max_length=50, blank=True)  # "5.5 quarts", etc.
...
class TorqueSetting(models.Model):
    ...
    component = models.CharField(max_length=100)  # "Oil drain plug", "Wheel lugs", etc.
    torque_value = models.CharField(max_length=50)  # "25 ft-lbs", "90 Nm", etc.
    notes = models.TextField(blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class MaintenanceRecord(models.Model):
    ...
    location = models.CharField(max_length=100, blank=True)  # Shop name or "DIY"
    description = models.TextField(blank=True)
